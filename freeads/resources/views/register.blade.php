...
<div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-4">
    <h1 class="text-4xl font-bold mb-8 text-gray-800">Register</h1>

    <form class="w-full max-w-sm bg-white p-6 rounded-lg shadow-md space-y-5" method="POST" action="{{ route('register') }}">
        @csrf
